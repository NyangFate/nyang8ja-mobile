...
export class Class00AuthAPIApi extends runtime.BaseAPI {
     ...
     * 애플 로그인
     */
    async appleSignInRaw(requestParameters: AppleSignInRequest): Promise<runtime.ApiResponse<TokenResponseDto>> {
        if (requestParameters.appleSignInRequestDto === null || requestParameters.appleSignInRequestDto === undefined) {
            throw new runtime.RequiredError('appleSignInRequestDto','Required parameter requestParameters.appleSignInRequestDto was null or undefined when calling appleSignIn.');
        }
     ...
     * 카카오 로그인
     */
    async kakaoSignInRaw(requestParameters: KakaoSignInRequest): Promise<runtime.ApiResponse<TokenResponseDto>> {
        if (requestParameters.kakaoSignInRequestDto === null || requestParameters.kakaoSignInRequestDto === undefined) {
            throw new runtime.RequiredError('kakaoSignInRequestDto','Required parameter requestParameters.kakaoSignInRequestDto was null or undefined when calling kakaoSignIn.');
        }
