...
export class Class99DummyTestApi extends runtime.BaseAPI {
  ...
  async healthCheckRaw(
  ...
  ): Promise<runtime.ApiResponse<DummyResponseDto>> {
    if (requestParameters.say === null || requestParameters.say === undefined) {
      throw new runtime.RequiredError(
        'say',
        'Required parameter requestParameters.say was null or undefined when calling healthCheck.'
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      DummyResponseDtoFromJSON(jsonValue)
    );
  }
   ...
   * 테스트용 GET API 입니다.
   */
  async userKeyCheckRaw(
    requestParameters: UserKeyCheckRequest
  ): Promise<runtime.ApiResponse<DummyResponseDto>> {
    if (requestParameters.say === null || requestParameters.say === undefined) {
      throw new runtime.RequiredError(
        'say',
        'Required parameter requestParameters.say was null or undefined when calling userKeyCheck.'
      );
    }
   ...
   * 테스트용 POST API 입니다.
   */
  async userKeyCheck22Raw(
    requestParameters: UserKeyCheck22Request
  ): Promise<runtime.ApiResponse<DummyResponseDto>> {
    if (
      requestParameters.dummyRequestBodyDto === null ||
      requestParameters.dummyRequestBodyDto === undefined
    ) {
      throw new runtime.RequiredError(
        'dummyRequestBodyDto',
        'Required parameter requestParameters.dummyRequestBodyDto was null or undefined when calling userKeyCheck22.'
      );
    }
